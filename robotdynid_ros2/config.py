...
def identification_config(config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "torque_weighting": str(identification.get("torque_weighting", "torque_std")),
        "measurement_torque_std": as_csv(identification.get("measurement_torque_std", "")),
        "linear_regularization_strength": as_float(identification.get("linear_regularization_strength"), 0.0),
        "linear_regularization_prior_source": str(identification.get("linear_regularization_prior_source", "zero")),
        "linear_regularization_prior": as_csv(identification.get("linear_regularization_prior", "")),
        "linear_regularization_prior_std": as_csv(identification.get("linear_regularization_prior_std", "")),
        "linear_regularization_covariance": identification.get("linear_regularization_covariance", []),
        "robust_loss": str(identification.get("robust_loss", "linear")),
        "robust_f_scale": as_float(identification.get("robust_f_scale"), 1.0),
        "robust_max_iterations": as_int(identification.get("robust_max_iterations"), 5),
        "output_dir": str(identification.get("output_dir", "")),
        "prediction_plot_stride": as_int(identification.get("prediction_plot_stride"), 0),
        "prediction_plot_rate_hz": as_float(identification.get("prediction_plot_rate_hz"), 10.0),
...
def trajectory_config(config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "friction_speed_levels": as_int(generation.get("friction_speed_levels"), 3),
        "gravity_pose_count": as_int(generation.get("gravity_pose_count"), 5),
        ...
        "position_lower": generation.get("position_lower", []),
        "position_upper": generation.get("position_upper", []),
...
def export_runtime_config(config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "include_subdir": str(export.get("include_subdir", "")),
        "source_subdir": str(export.get("source_subdir", "")),
        "runtime_subdir": str(export.get("runtime_subdir", "")),
